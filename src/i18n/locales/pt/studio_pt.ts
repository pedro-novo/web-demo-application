export const studio_pt = {
  ...
  textBlocks: {
    launch: 'Lance rapidamente uma prova de conceito.',
    build: 'Crie IVRs para cada utilizador, em qualquer canal.',
    start: 'Comece gratuitamente. Pague à medida que avança.',
  },
};
