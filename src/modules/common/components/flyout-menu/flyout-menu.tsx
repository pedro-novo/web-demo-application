...
export const FlyoutMenu: React.FC<Props> = ({ title }) => {
  return (
    <Popover className='relative'>
      <Popover.Button className='inline-flex items-center gap-x-1 text-sm font-light leading-6 text-[#2a3076] hover:text-[#0263f4]'>
        <span>{title}</span>
